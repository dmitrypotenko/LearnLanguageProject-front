...
export class TestService {
  ...
  getTestsFor(courseId: number): Observable<TestData[]> {
    return of([new TestData([new QuestionData('Are you gay?', [new VariantData('yes', false, false, false, 0),
        new VariantData('No', false, false, false, 1), new VariantData('Maybe...', false, false, false, 2)
      ], 0, false), new QuestionData('Do you like learning English?', [new VariantData('No', false, false, false, 3),
        new VariantData('No', false, false, false, 4), new VariantData('No...', false, false, false, 5)
      ], 1, true)
